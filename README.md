...
Welcome! `sinhpy`'s goal is to provide researchers with an easy-to-use, one-stop-shop for methods and analyses aimed at studying inter-individual differences in neuroimaging.
...
This lead us to develop `sinhpy`, as a way to adapt and store existing methodology and create new methods to study inter-individual differences. Step-by-step examples are available in the documentation found here: PLACEHOLDER. 
...
- Fingerprinting - Determines individual-specific brain signatures of each individual and the related metrics
